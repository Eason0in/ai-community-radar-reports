# AI Community Radar - 2026-09-02

> Generated: 2026-09-02T00:56:11.409Z
> Timezone: Asia/Taipei
> Active cutoff: updated since 2026-08-31; archived GitHub repos excluded; max stale age 2 days.
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 245,761 | 37,087 | JavaScript | 2026-08-31T22:18:39Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 239,515 | 48,937 | Python | 2026-09-02T00:44:38Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 198,351 | 76,228 | C++ | 2026-09-02T00:52:26Z |
...
| Active baseline since | 2026-08-31 |
...
#### 6. [navidmoazzez/apple-photos-mcp](https://github.com/navidmoazzez/apple-photos-mcp)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Apple Photos MCP server for Claude Code and AI agents. Photo search, scene labels, text in images, faces, places, albums, previews, and exports. |
...
#### 7. [techwright-lab/groundcrew-seo](https://github.com/techwright-lab/groundcrew-seo)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | The open skills that put your AI on TrustGrowth's growth team |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |

#### 8. [zihin-ai/gemini-cli-zihin](https://github.com/zihin-ai/gemini-cli-zihin)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Gemini CLI extension for the Zihin.ai agent platform (MCP + skills context) |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
