# AI Community Radar - 2026-09-10

> Generated: 2026-09-10T00:56:37.104Z
> Timezone: Asia/Taipei
> Active cutoff: updated since 2026-09-08; archived GitHub repos excluded; max stale age 2 days.
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 255,179 | 38,226 | JavaScript | 2026-09-09T19:00:49Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 243,861 | 50,342 | Python | 2026-09-10T00:50:50Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 199,308 | 76,279 | C++ | 2026-09-10T00:50:35Z |
...
| Active baseline since | 2026-09-08 |
...
#### 6. [bobmatnyc/trusty-tools](https://github.com/bobmatnyc/trusty-tools)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Unified Rust workspace for the trusty-* AI developer-tooling ecosystem: hybrid code search, memory palace, code analysis, PR review, and the MPM multi-agent platform — MCP servers, daemons & CLIs. |
...
#### 7. [bscott/rdc](https://github.com/bscott/rdc)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Remote Desktop Control for AI agents: screenshot, mouse, keyboard and window control of another machine over Tailscale, exposed as MCP tools. Built with Rust |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |

#### 8. [yersonargotev/engram](https://github.com/yersonargotev/engram)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Persistent memory system for AI coding agents. Agent-agnostic Go binary with SQLite + FTS5, MCP server, HTTP API, CLI, and TUI. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
