...
> Generated: 2026-08-13T00:31:21.575Z
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 239,755 | 36,390 | JavaScript | 2026-08-12T22:45:12Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 229,567 | 45,321 | Python | 2026-08-13T00:30:41Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 196,983 | 76,001 | C++ | 2026-08-13T00:29:10Z |
...
#### 6. [chrismeyersfsu/caseclerk](https://github.com/chrismeyersfsu/caseclerk)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Case-file MCP server for a small law firm: constrained access to local case documents, token-efficient preprocessing, and Outlook-ready email drafts. |
...
#### 7. [Sinity/polylogue](https://github.com/Sinity/polylogue)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | A local evidence system for AI work—unifying ChatGPT, Claude, Codex, Gemini, and agent histories into one searchable, auditable archive. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |

#### 8. [breitreiter/nb](https://github.com/breitreiter/nb)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | A feature-rich AI CLI |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
