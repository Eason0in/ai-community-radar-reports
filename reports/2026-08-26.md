# AI Community Radar - 2026-08-26

> Generated: 2026-08-25T23:29:39.505Z
> Timezone: Asia/Taipei
> Active cutoff: updated since 2026-08-23; archived GitHub repos excluded; max stale age 2 days.
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 243,195 | 36,790 | JavaScript | 2026-08-25T21:27:27Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 236,400 | 47,732 | Python | 2026-08-25T23:29:10Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 197,632 | 76,133 | C++ | 2026-08-25T23:27:42Z |
...
| Active baseline since | 2026-08-23 |
...
#### 5. [@launchdarkly/mcp-server](https://www.npmjs.com/package/@launchdarkly/mcp-server)
...
#### 6. [artokun/comfyui-mcp](https://github.com/artokun/comfyui-mcp)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Local-first, agent-native control plane for ComfyUI — MCP server + sidebar agent that generates images, video & audio, authors and runs workflows, and edits your live graph in natural language on ANY LLM (Claude, ChatGPT, Gemini, offline Ollama, or any hosted model). 178 tools, 36 AI skills, 55 installer packs. Local, LAN, VPS, or Comfy Cloud. |
...
#### 7. [brightwave-inc/tidebreak](https://github.com/brightwave-inc/tidebreak)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Open-source, local-first desktop for AI coding agents and document work. Run Claude Code, Codex CLI, opencode, and Grok CLI in isolated Git worktrees. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |

#### 8. [Berrio/inkscape-mcp](https://github.com/Berrio/inkscape-mcp)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | MCP server for secure headless Inkscape document design and exports |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
