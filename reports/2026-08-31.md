# AI Community Radar - 2026-08-31

> Generated: 2026-08-31T01:17:54.172Z
> Timezone: Asia/Taipei
> Active cutoff: updated since 2026-08-29; archived GitHub repos excluded; max stale age 2 days.
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 244,727 | 36,989 | JavaScript | 2026-08-30T22:54:01Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 238,510 | 48,573 | Python | 2026-08-31T01:10:47Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 198,073 | 76,203 | C++ | 2026-08-31T00:55:37Z |
...
| Active baseline since | 2026-08-29 |
...
#### 6. [sandbaseai/sandbase-harness](https://github.com/sandbaseai/sandbase-harness)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Local-first, self-hosted AI agent runtime and MCP bridge with sandboxed sessions, memory, credentials, audit/replay, and a local Console. |
...
#### 7. [ariffazil/arifOS](https://github.com/ariffazil/arifOS)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | [L0 CONSTITUTION] arifOS — constitutional MCP kernel. Law, identity, F1–F13, VAULT999. Judges but never executes. DITEMPA BUKAN DIBERI. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |

#### 8. [tanle-mtr/dsh-plogin-plugin-recommender](https://github.com/tanle-mtr/dsh-plogin-plugin-recommender)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | The most comprehensive AI-curated list of DeepSeek Harness (DSH) plugins - 190+ plugins, 12 categories, updated hourly by AI. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
