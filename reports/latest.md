# AI Community Radar - 2026-08-28

> Generated: 2026-08-28T06:50:16.304Z
> Timezone: Asia/Taipei
> Active cutoff: updated since 2026-08-26; archived GitHub repos excluded; max stale age 2 days.
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 243,810 | 36,874 | JavaScript | 2026-08-28T01:14:39Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 237,448 | 48,142 | Python | 2026-08-28T06:24:34Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 197,751 | 76,168 | C++ | 2026-08-28T06:46:46Z |
...
| Active baseline since | 2026-08-26 |
...
#### 6. [Didione110/kb](https://github.com/Didione110/kb)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | 科情客服智能知识库：VitePress 门户 + REST API + MCP Server |
...
#### 7. [ljppanda/mcp-longjobs](https://github.com/ljppanda/mcp-longjobs)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Durable, resumable operations for MCP: long-running tasks and large file transfers that survive timeouts, disconnects, and client restarts. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |

#### 8. [sky-unicorn/dsh-enhanced-plugins](https://github.com/sky-unicorn/dsh-enhanced-plugins)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | DeepSeek Harness（DSH）一站式增强套件，基于公开插件扩展点构建，无需修改 DSH Core。提供 Windows Launcher、桌面通知与动态桌宠、Plugin Community、MCP Server Manager、模型输入类型配置、最后一条消息编辑与重新生成，以及 Claude Code / Codex Subagents 实时控制。所有功能均可独立安装，支持全量部署、按需组合、升级迁移与安全卸载。 |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
