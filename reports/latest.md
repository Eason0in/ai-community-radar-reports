# AI Community Radar - 2026-08-24

> Generated: 2026-08-23T23:26:27.486Z
> Timezone: Asia/Taipei
> Active cutoff: updated since 2026-08-21; archived GitHub repos excluded; max stale age 2 days.
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 234,955 | 47,330 | Python | 2026-08-23T23:25:33Z |
| 2 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 197,375 | 76,115 | C++ | 2026-08-23T18:16:01Z |
| 3 | [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 186,826 | 46,050 | Python | 2026-08-23T13:10:52Z |
...
| Active baseline since | 2026-08-21 |
...
#### 6. [kernel/kernel-mcp-server](https://github.com/kernel/kernel-mcp-server)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Open-source MCP server for secure, low-latency cloud-browser automation on Kernel. |
...
#### 7. [modelcontextprotocol/php-sdk](https://github.com/modelcontextprotocol/php-sdk)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | The official PHP SDK for Model Context Protocol servers and clients. Maintained in collaboration with The PHP Foundation. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |

#### 8. [derleiti/ai-coder](https://github.com/derleiti/ai-coder)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Terminal Coding & DevOps Agent for AILinux/TriForce — autonomous tool loop, opencode-style UI |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
