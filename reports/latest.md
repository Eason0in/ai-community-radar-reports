# AI Community Radar - 2026-09-01

> Generated: 2026-09-01T01:44:54.061Z
> Timezone: Asia/Taipei
> Active cutoff: updated since 2026-08-30; archived GitHub repos excluded; max stale age 2 days.
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 245,265 | 37,057 | JavaScript | 2026-08-31T22:18:39Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 239,033 | 48,756 | Python | 2026-09-01T01:43:36Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 198,095 | 76,230 | C++ | 2026-09-01T01:41:03Z |
...
| Active baseline since | 2026-08-30 |
...
#### 6. [konweb/nanteyomu](https://github.com/konweb/nanteyomu)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | IT のツール名・サービス名の読み方を、出典つきで引ける辞典。Web + CLI + MCP。 |
...
#### 7. [ianchesal/unifi-siem-lens](https://github.com/ianchesal/unifi-siem-lens)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | A view and analysis layer on top of the unifi-siem-sink dataset |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |

#### 8. [kgoedecke/doop](https://github.com/kgoedecke/doop)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | The open-source alternative to Paper.design. A multiplayer design canvas where humans and AI agents design together, live. MCP built in. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
