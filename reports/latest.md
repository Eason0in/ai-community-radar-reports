# AI Community Radar - 2026-08-25

> Generated: 2026-08-24T23:27:04.552Z
> Timezone: Asia/Taipei
> Active cutoff: updated since 2026-08-22; archived GitHub repos excluded; max stale age 2 days.
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 242,917 | 36,760 | JavaScript | 2026-08-24T05:00:04Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 235,770 | 47,570 | Python | 2026-08-24T22:18:09Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 197,559 | 76,115 | C++ | 2026-08-24T23:14:43Z |
...
| Active baseline since | 2026-08-22 |
...
#### 6. [Above-the-Fold-Studio/designmd-skills](https://github.com/Above-the-Fold-Studio/designmd-skills)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Provenance-first DesignMD workflows for coding agents. |
...
#### 7. [protella/chatgpt-bots](https://github.com/protella/chatgpt-bots)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | ChatGPT-powered Slack bot with image generation, vision analysis, document processing, and channel participation — built on OpenAI's Responses API. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
