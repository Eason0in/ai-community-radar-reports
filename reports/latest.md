# AI Community Radar - 2026-08-27

> Generated: 2026-08-27T04:27:04.915Z
> Timezone: Asia/Taipei
> Active cutoff: updated since 2026-08-25; archived GitHub repos excluded; max stale age 2 days.
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 243,559 | 36,836 | JavaScript | 2026-08-25T21:27:27Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 236,968 | 47,936 | Python | 2026-08-27T04:17:58Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 197,641 | 76,153 | C++ | 2026-08-27T03:59:41Z |
...
| Active baseline since | 2026-08-25 |
...
#### 6. [notpritam/4amcasino](https://github.com/notpritam/4amcasino)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Provably-fair Texas Hold'em for friend groups — mental poker on ristretto255, a hash-chained ledger, a cyberpunk UI, and a 3D casino world with emotes. Nobody sees a card they shouldn't, not even the server. |
...
#### 7. [rinkymahd/gdrive-mcp-server](https://github.com/rinkymahd/gdrive-mcp-server)
...
#### 8. [mikeylong/judgmentkit](https://github.com/mikeylong/judgmentkit)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | Activity-first judgment layer for AI-generated product work |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
