...
> Generated: 2026-09-03T01:01:54.472Z
...
| --- | --- | ---: | ---: | --- | --- |
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 246,345 | 37,150 | JavaScript | 2026-09-03T00:48:58Z |
| 2 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 240,126 | 49,134 | Python | 2026-09-02T23:38:23Z |
| 3 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 198,363 | 76,228 | C++ | 2026-09-03T00:51:49Z |
...
#### 6. [seancrecord/scvd-general-store-repo](https://github.com/seancrecord/scvd-general-store-repo)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | scvd.store is an evidence observatory for agentic commerce. Free preflight and conformance checks on any issuer's x402 doors, offers and receipts — including competitors'. Every verdict is one dated observation, signed and verifiable offline, published with the gaps counted against itself. Bitcoin-anchored corpus. USDC on Base, Polygon & Solana. |
...
#### 7. [BowyerApp/bowyer](https://github.com/BowyerApp/bowyer)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | The App Store for Autonomous Businesses. Build, discover, and grow AI businesses on Robinhood Chain. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |

#### 8. [jaquelineleite/ai-quality-engineering-lab](https://github.com/jaquelineleite/ai-quality-engineering-lab)

| 欄位 | 內容 |
| --- | --- |
| 類型 | github-repo |
| 說明 | AI-Native Quality Engineering Lab with MCP, Playwright, Open Banking APIs, local LLMs, Golden Dataset, LLM evaluation and CI/CD Quality Gates. |
| 為什麼值得看 | GitHub 上近 2 天仍有更新、且不是 archived 的 MCP 相關 repo，但在本次官方 MCP Registry 取樣中沒有命中。 |
| 下一步 | 先跑通 server、檢查工具 schema 描述，再幫作者補 registry submission 或整理成可安裝 npm package。 |
